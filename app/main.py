...
img = pygame.image.load("app/head.png")
pygame.display.set_icon(img)
pygame.display.set_caption("Dendam si Tikus")
clock = pygame.time.Clock()

#Pemuatan gambar
background_img = pygame.image.load(os.path.join("app", "img", "background.png")).convert()
mouse_img1 = pygame.image.load(os.path.join("app", "img", "mouse1.png")).convert_alpha()
mouse_img2 = pygame.image.load(os.path.join("app", "img", "mouse2.png")).convert_alpha()
...
poison_img = pygame.image.load(os.path.join("app", "img", "poison.png")).convert_alpha()
cat_imgs = []
for i in range(7): 
    cat_imgs.append(pygame.image.load(os.path.join("app", "img", f"cat{i}.png")).convert_alpha())
expl_anim = {}
expl_anim["lg"] = []
expl_anim["sm"] = []
expl_anim["mouse"] = []
for i in range(9):
    expl_img = pygame.image.load(os.path.join("app", "img", f"expl{i}.png")).convert()
    expl_img.set_colorkey(BLACK)
    expl_anim["lg"].append(pygame.transform.scale(expl_img,(75,75)))
    expl_anim["sm"].append(pygame.transform.scale(expl_img,(30,30)))
    mouse_expl_img = pygame.image.load(os.path.join("app", "img", f"mouse_expl{i}.png")).convert()
    mouse_expl_img.set_colorkey(BLACK)
    expl_anim["mouse"].append(mouse_expl_img)
power_imgs = {}
power_imgs["shield"] = pygame.image.load(os.path.join("app", "img", "shield.png")).convert_alpha()   
power_imgs["gun"] = pygame.image.load(os.path.join("app", "img", "gun.png")).convert_alpha() 

#Pemuatan suara
shoot_sound = pygame.mixer.Sound(os.path.join("app", "sound", "shoot.wav"))
gun_sound = pygame.mixer.Sound(os.path.join("app", "sound", "pow1.wav"))
shield_sound = pygame.mixer.Sound(os.path.join("app", "sound", "pow0.wav"))
die_sound = pygame.mixer.Sound(os.path.join("app", "sound", "rumble.ogg"))
expl_sounds = [
    pygame.mixer.Sound(os.path.join("app", "sound", "expl0.wav")),
    pygame.mixer.Sound(os.path.join("app", "sound", "expl1.wav"))
]
pygame.mixer.music.load(os.path.join("app", "sound", "background.ogg"))
pygame.mixer.music.set_volume(0.3)

font_name = os.path.join("app", "font.otf") 
...
def character_selection():
    ...
    x1 = 65
    y1 = 150
    player_img1 = pygame.image.load(os.path.join("app", "img", "mouse1_select.png")).convert_alpha()
    ...
    x2 = 320
    y2 = 150
    player_img2 = pygame.image.load(os.path.join("app", "img", "mouse2_select.png")).convert_alpha()
...
def lose():
    with open('app/data/topScore.json') as dat:
        data = json.load(dat)
